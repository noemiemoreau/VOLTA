...
def main():
    ...
    source = "/scratch/nmoreau/volta/new_kidney_data_300_40x_wo_outside/validation/"
    destination = "/scratch/nmoreau/volta/new_kidney_data_300_40x_wo_outside/validation_cells/"
