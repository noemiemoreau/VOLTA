...
def main():
    ...
    source = "/scratch/nmoreau/volta/new_kidney_data_300_40x_wo_outside/train/"
    destination = "/scratch/nmoreau/volta/new_kidney_data_300_40x_wo_outside/training_cells/"
